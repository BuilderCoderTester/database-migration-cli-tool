...
//                    loader.loadPendingMigrations(currentOpt.orElse(null), connectionId);
    ...
    public MigrationResultResponseDto migrate(MigrationRequest migrationRequest) throws SQLException {
...
//                    loader.loadPendingMigrations(currentOpt.orElse(null), connectionId);
            ...
            if (pending.isEmpty()) {
                return new MigrationResultResponseDto("✓ No pending migrations", 0, 0);
            }
            ...
            return new MigrationResultResponseDto("✗ Migration failed: " + e.getMessage(), 0, 0);
...
//    }
    ...
    public ConnectionResponseDto connect(ConnectionRequest request) {
        ...
        try {
            ...
            return new ConnectionResponseDto(true, "Connection successful", saved.getConnectionId());
...
//    }
    ...
    public MigrationResultResponseDto migrateUpdatedScript(MigrationRequest request, String version) throws IOException {
